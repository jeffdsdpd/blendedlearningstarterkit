...
import 'package:blendedlearningtoolkit/doc_category/covidslidevideolist.dart';
...
class CovidSlideDefinitionPage extends StatefulWidget {
CovidSlideDefinitionPage({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _CovidSlideDefinitionPageState createState() => _CovidSlideDefinitionPageState();
}

class _CovidSlideDefinitionPageState extends State<CovidSlideDefinitionPage> {
  List lessons;
  final List<CovidSlideVideo> _allVideos = CovidSlideVideo.allVideos();
   ...
   return new Scaffold(
      ...
      title: RichText(
            text: TextSpan(children: [
              ...
              TextSpan( text: 'Covid Slide', style: TextStyle(fontSize: 22.0)
              )
            ],
