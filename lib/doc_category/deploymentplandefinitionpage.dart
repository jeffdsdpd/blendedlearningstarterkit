...
import 'package:blendedlearningtoolkit/doc_category/deploymentplanvideolist.dart';
...
class DeploymentPlanDefinitionPage extends StatefulWidget {
DeploymentPlanDefinitionPage({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _DeploymentPlanDefinitionPageState createState() => _DeploymentPlanDefinitionPageState();
}

class _DeploymentPlanDefinitionPageState extends State<DeploymentPlanDefinitionPage> {
  List lessons;
  final List<DeploymentPlanVideo> _allVideos = DeploymentPlanVideo.allVideos();
   ...
   return new Scaffold(
      ...
      title: RichText(
            text: TextSpan(children: [
              ...
              TextSpan( text: 'Deployment Plan', style: TextStyle(fontSize: 22.0)
              )
            ],
