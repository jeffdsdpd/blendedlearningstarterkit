...
import 'package:blendedlearningtoolkit/doc_category/newnormalvideolist.dart';
...
class NewNormalDefinitionPage extends StatefulWidget {
NewNormalDefinitionPage({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _NewNormalDefinitionPageState createState() => _NewNormalDefinitionPageState();
}

class _NewNormalDefinitionPageState extends State<NewNormalDefinitionPage> {
  List lessons;
  final List<NewNormalVideo> _allVideos = NewNormalVideo.allVideos();
   ...
   return new Scaffold(
      ...
      title: RichText(
            text: TextSpan(children: [
              ...
              TextSpan( text: 'The New Norm', style: TextStyle(fontSize: 22.0)
              )
            ],
