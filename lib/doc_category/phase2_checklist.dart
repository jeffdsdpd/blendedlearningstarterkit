...
class Phase2Page extends StatefulWidget {
Phase2Page({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _Phase2PageState createState() => _Phase2PageState();
}

class _Phase2PageState extends State<Phase2Page> {
  List lessons;
