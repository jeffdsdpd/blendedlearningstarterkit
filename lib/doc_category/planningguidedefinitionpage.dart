...
import 'package:blendedlearningtoolkit/doc_category/planningguidevideolist.dart';
...
class PlanningGuideDefinitionPage extends StatefulWidget {
PlanningGuideDefinitionPage({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _PlanningGuideDefinitionPageState createState() => _PlanningGuideDefinitionPageState();
}

class _PlanningGuideDefinitionPageState extends State<PlanningGuideDefinitionPage> {
  List lessons;
  final List<PlanningGuideVideo> _allVideos = PlanningGuideVideo.allVideos();
   ...
   return new Scaffold(
      ...
      title: RichText(
            text: TextSpan(children: [
              ...
              TextSpan( text: 'Planning Guide', style: TextStyle(fontSize: 22.0)
              )
            ],
