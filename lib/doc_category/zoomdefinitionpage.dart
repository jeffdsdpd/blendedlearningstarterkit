...
import 'package:blendedlearningtoolkit/doc_category/zoomvideolist.dart';
import 'package:blendedlearningtoolkit/youtubeplayer_page.dart';
import 'package:flutter/material.dart';

class ZOOMDefinitionPage extends StatefulWidget {
ZOOMDefinitionPage({this.auth, this.onSignedOut});

final BaseAuth auth;
final VoidCallback onSignedOut;

@override
  _ZOOMDefinitionPageState createState() => _ZOOMDefinitionPageState();
}

class _ZOOMDefinitionPageState extends State<ZOOMDefinitionPage> {
  List lessons;
  final List<ZOOMVideo> _allVideos = ZOOMVideo.allVideos();
   ...
   return new Scaffold(
      ...
      title: RichText(
            text: TextSpan(children: [
              ...
              TextSpan( text: 'ZOOM Videos', style: TextStyle(fontSize: 22.0)
              )
            ],
